    ...
    def initialize_directory(self):
        ...
        try:
            ...
            if home_dir:
                ...
                print(f"Session initialized at home directory: {self.current_directory}")
            else:
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(ssm_session.execute_command("mkdir -p test_dir && cd test_dir && pwd && touch inside_file.txt && ls -la"))
